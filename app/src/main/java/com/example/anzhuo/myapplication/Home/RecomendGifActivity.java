 ...
 */
public class RecomendGifActivity  extends Activity{
    ImageView iv_head;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recommend_gif_activity);
...
//        tv_name.setText(intent.getExtras().getString("name"));
        ...
        iv_content.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(RecomendGifActivity.this, GifShowerActivity.class);
